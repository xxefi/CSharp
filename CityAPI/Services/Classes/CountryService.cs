...
namespace CityAPI.Services.Classes
{
    public class CountryService : ICountryService
    {
        ...
        public async Task<CountryInfo.Rootobject> GetCountryAsync(string country)
        {
            ...
            try
            {
                ...
                CountryInfo.Rootobject[] info = JsonConvert.DeserializeObject<CountryInfo.Rootobject[]>(json);
